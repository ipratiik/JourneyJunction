...
class run():
    ...
    def Login_Interface(self):
        ...
        Title = Label(Login_Frame, text = "Sign In", font = ("FZShuTi", 50, "bold"), bg = "#F3AE58", fg = "#021E2F").place(x = 48, y = 20)

        Username = Label(Login_Frame, text = "Username", font = ("Product Sans", 20, "bold"), bg = "#F3AE58", fg = "#630000").place(x = 50, y = 130)
        self.txt_Username = Entry (Login_Frame, font = ("Product Sans", 15), bg = "#FFEFD5",fg="#000000")
        self.txt_Username.place(x = 50, y = 170, height = 35, width = 350)

        Password = Label(Login_Frame, text = "Password", font = ("Product Sans", 20, "bold"), bg = "#F3AE58", fg = "#000000").place(x = 50, y = 230)
        self.txt_Password = Entry (Login_Frame, font = ('Calibri bold', 18, "bold"), bg = "#FFEFD5", show = "*",fg="#000000")
        self.txt_Password.place(x = 50, y = 270, height = 35, width = 350)

        btn_register = Button(Login_Frame, text = "Login",font = ('Calibri bold', 40,'bold'), bd = 1, bg = "#F3AE58", cursor = 'hand2',fg="#000000", relief = RIDGE, command = self.Login)
        btn_register.place(x = 250, y = 330, height = 80, width = 150)

        Title = Label(Login_Frame, text = "Don't Have an Account?", font = ("FZShuTi", 15, 'bold'), bg = "#F3AE58", fg = "#021E2F").place(x = 50, y = 335)
        btn_login = Button(self.root, text = "Sign Up", font = ('Calibri bold', 25,'bold'), bg = "#F99A05", bd = 1, relief = RIDGE, cursor = "hand2", command = self.Registration_Interface)
    ...
    def Registration_Interface(self):
        ...
        title = Label(Registration_Frame, text = "Sign Up", font = ("FZShuTi", 50, "bold"), bg = "#F3AE58", fg = "#021E2F").place(x = 70, y = 10)

        FirstName = Label(Registration_Frame, text = "First Name", font = ("Product Sans", 15, "bold"), bg = "#F3AE58", fg = "#630000").place(x = 70, y = 120)
        self.txt_FirstName = Entry (Registration_Frame, font = ("Product Sans", 15), justify = CENTER, bg = "#FFEFD5",fg="#000000")
        ...
        self.txt_LastName = Entry (Registration_Frame, font = ("Product Sans", 15), justify = CENTER, bg = "#FFEFD5",fg="#000000")
        ...
        self.txt_Username = Entry (Registration_Frame, font = ("Product Sans", 15), justify = CENTER, bg = "#FFEFD5",fg="#000000")
        ...
        self.txt_Email = Entry (Registration_Frame, font = ("Product Sans", 15), justify = CENTER, bg = "#FFEFD5",fg="#000000")
        ...
        self.txt_Password = Entry (Registration_Frame, font = ("Product Sans", 15), justify = CENTER, bg = "#FFEFD5", show = "*",fg="#000000")
        ...
        self.txt_ConfirmPassword = Entry (Registration_Frame, font = ("Product Sans", 15), justify = CENTER, bg = "#FFEFD5", show = "*",fg="#000000")
        self.txt_ConfirmPassword.place(x = 380, y = 300, width = 250)

        btn_register = Button(Registration_Frame, text = "Register",font = ("20th Century Font", 40,'bold'), bd = 1, bg = "#F99A05", cursor = 'hand2', relief = RIDGE, command = self.Registration)
        btn_register.place(x = 410, y = 355, height = 60, width = 200)

        Title = Label(Registration_Frame, text = "Already Have An Account?", font = ("FZShuTi", 15, 'bold'), bg = "#F3AE58", fg = "#021E2F").place(x = 90, y = 345)
        btn_login = Button(self.root, text = "Sign In", font = ("20th Century Font", 20,'bold'), bg = "#F99A05", bd = 1, relief = RIDGE, cursor = "hand2", command = self.Login_Interface)
        btn_login.place(x = 729, y = 555, height = 40, width = 110)
